    ...
    <>
      ...
      <main>
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16">
          <div className="bg-surface rounded-[2.5rem] overflow-hidden shadow-card-hover border border-gray-200">
            <div className="grid lg:grid-cols-2 gap-0">
              <div className="p-8 sm:p-12 lg:p-16 flex flex-col justify-center">
                <span className="inline-flex text-xs font-bold bg-accent px-3 py-1 rounded-full w-fit mb-4 text-gray-900">Osiris for creators &amp; agents</span>
                <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-bold leading-[1.1]">Get paid to do what you love</h1>
                <p className="mt-4 text-gray-700 text-lg max-w-md leading-relaxed">Find the next collaboration that gets you excited. Set your rates, share your media kit, and track approvals—without chasing brands.</p>
                <div className="mt-8 flex flex-wrap gap-3">
                  <Link href="/auth?tab=signup&role=creator" className="inline-flex items-center gap-2 bg-black text-white font-semibold text-sm px-6 py-3.5 rounded-full hover:bg-gray-800 transition-all shadow-md">Join for Free</Link>
              ...
              <div className="p-6 lg:p-8">
                <div className="grid grid-cols-2 gap-3 h-full min-h-[300px]">
                  <div className="bg-pink-400 rounded-3xl row-span-2 relative shadow-md">
                  ...
                  <div className="bg-amber-400 rounded-3xl shadow-md"></div>
                  <div className="bg-neon-blue rounded-3xl shadow-md"></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              {[{ n: "1", t: "Create Your Profile", d: "Create your personal page and list your services for Instagram, TikTok, YouTube, and UGC." },
                ...
                <div key={i} className={`rounded-3xl p-6 text-white shadow-card ${["bg-brand", "bg-gray-800", "bg-gray-900"][i]}`}>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {[{ icon: Handshake, t: "Get Brand Deals", d: "Get discovered by thousands of brands on our marketplace looking to work with you." },
                ...
                <div key={i} className="bg-white border border-gray-200 rounded-3xl p-6 shadow-card hover:shadow-card-hover transition-all">
