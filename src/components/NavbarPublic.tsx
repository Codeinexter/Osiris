    ...
    <nav className="sticky top-0 z-50 bg-white/95 backdrop-blur-sm border-b border-gray-200 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-3">
            <Link href="/auth" className="text-sm font-medium px-5 py-2.5 rounded-full border border-gray-300 hover:bg-gray-50 transition-all">
              Log in
            </Link>
            <Link href="/auth" className="text-sm font-medium px-5 py-2.5 rounded-full bg-gray-900 text-white hover:bg-gray-800 transition-all shadow-md">
              Get started
            </Link>
          </div>
      ...
      {open && (
        <div className="md:hidden border-t border-gray-200 bg-white px-4 py-4 space-y-3">
          ...
          <Link href="/auth" className="block text-sm font-medium py-2 px-4 bg-gray-900 text-white rounded-full text-center">Get started</Link>
        </div>
      )}
    </nav>
  );
